...
import com.phamchien.config.SecurityConstant;
import com.phamchien.constant.UserBaseConstant;
import com.phamchien.jwt.UserBaseJwt;
import com.phamchien.model.Account;
import com.phamchien.repository.AccountRepository;
import com.phamchien.repository.GroupRepository;
...
public class UserServiceImpl implements UserDetailsService {
    ...
    public OAuth2AccessToken getAccessTokenForPasswordGrant(ClientDetails client, TokenRequest tokenRequest, String username, String password, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
    ...
    public OAuth2AccessToken getAccessTokenForOtp(ClientDetails client, TokenRequest tokenRequest, String otpCode, String phone, AuthorizationServerTokenServices tokenServices){
        if (otpCode == null || !Objects.equals(otpCode, "123456")) {
            log.error("Invalid OTP for phone: " + phone);
        ...
        Map<String, String> requestParameters = new HashMap<>();
        requestParameters.put("grantType", SecurityConstant.GRANT_TYPE_OTP);
